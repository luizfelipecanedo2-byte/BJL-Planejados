...
import { Plus, Pencil, Trash2, Home, TrendingUp, DollarSign } from "lucide-react";
...
interface ServiceExpensesTabProps {
    ...
    handleDeleteServiceExpense: (id: string) => void;
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6 bg-muted/20 p-6 rounded-2xl border border-border/50 shadow-sm transition-all hover:bg-muted/30">
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                        <h3 className="text-2xl font-black tracking-tight text-secondary-foreground uppercase tracking-widest">Gastos por Serviços <span className="text-[10px] font-normal text-muted-foreground ml-2 tracking-normal lowercase italic">(Adição Manual)</span></h3>
                        <p className="text-xs text-muted-foreground font-medium uppercase opacity-70">Análise de Margem por Projeto</p>
                    </div>
                </div>
